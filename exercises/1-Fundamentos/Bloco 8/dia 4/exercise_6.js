...
//o formato { name: nome do aluno, average: media das notas } . Para isso vamos assumir que a posição 0 de notas 
...
function studentAverage() {
  const studentReduce = students.reduce((acc, student, index) => {
    const obj = {
      name: student,
