...
//com outras operações. Logo, adicione na função sendMarsTemperature um outro callback que contenha as ações a serem tomadas 
//em caso de falha.
...
const sendMarsTemperature = (temp, error) => {
  ...
  setTimeout(() => {
    (didOperationSucceed) ? temp(getMarsTemperature()) : error('Robot is busy');
  }, messageDelay());
}
